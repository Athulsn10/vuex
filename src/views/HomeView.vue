      ...
      <div class="col-3 mb-3" v-for="iceCream in iceCreams" :key="iceCream.id">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <button v-if="!iceCream.cart" class="btn btn-primary" @click="addToCart(iceCream)">${{ iceCream.price }}<i
                class="ms-2 fa-solid fa-cart-shopping"></i></button>
            <button v-else class="btn btn-danger" @click="removeCart(iceCream)">Remove<i
